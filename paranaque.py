...
for i, bbox in enumerate(bbox_list):
    ...
    url = f'https://graph.mapillary.com/images?access_token={client_token}&fields=id,geometry,thumb_2048_url&bbox={bbox_str}'
    ...
    if response.status_code == 200:
        ...
        if len(json['data']):
            for obj in json['data']:
                ...
                feature = geojson.Feature(geometry=obj['geometry'], properties={'id': obj['id'], 'thumb_2048_url': obj.get('thumb_2048_url', None)})
